...
public interface BufferedReaderAdventSolution<T1, T2> extends AdventSolution<T1, T2>, ResourceServiceHolder {
  @Override
  default T1 part1(@NotNull ResourceIdentifier identifier) throws Exception {
    return SolutionUtil.runWithResource(identifier, getResourceService()::asBufferedReader, this::part1);
  }

  @Override
  default T2 part2(@NotNull ResourceIdentifier identifier) throws Exception {
  ...
  T1 part1(@NotNull BufferedReader reader) throws Exception;

  T2 part2(@NotNull BufferedReader reader) throws Exception;
